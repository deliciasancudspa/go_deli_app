...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  final _banks = ["BancoEstado", "Banco de Chile", "BCI", "Banco Santander", "Banco Itau", "Scotiabank", "Banco Falabella", "Banco Ripley", "Banco Security", "Mercado Pago", "MACH", "Tenpo", "Otro"];
  ...
  Future<void> _submit() async {
    ...
    final err = await rider.register(
      ...
      accountRut: _accountRutCtrl.text.trim(),
    );
    if (err != null) {
      setState(() => _error = "Error al registrarse: $err");
    } else if (mounted) {
      context.go("/pending");
    }
  }

  Widget _field(TextEditingController c, String hint, IconData icon, {TextInputType type = TextInputType.text, bool obscure = false}) {
            ...
            children: [
              ...
              SingleChildScrollView(
                ...
                child: Column(children: [
                  const Text("Cuéntanos sobre ti", style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800)),
              ...
              SingleChildScrollView(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  const SizedBox(height: 24),
                  const Text("Tipo de vehiculo", style: TextStyle(fontWeight: FontWeight.w700, color: AppColors.textMedium)),
                  const SizedBox(height: 12),
                  GridView.count(
              ...
              SingleChildScrollView(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  const Text("Aqui recibirás tus ganancias cada semana", style: TextStyle(color: AppColors.textLight, fontSize: 14)),
                  const SizedBox(height: 24),
