    ...
    return PopScope(
      ...
      body: RefreshIndicator(
        ...
        child: rider.orderHistory.isEmpty
          ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [const Text("🛵", style: TextStyle(fontSize: 64)), const SizedBox(height: 16), Text(AppLocalizations.of(context)!.ordersEmpty, style: TextStyle(fontSize: 16, color: tc.textLight, fontWeight: FontWeight.w600))]))
          : ListView.builder(
              padding: const EdgeInsets.all(16),
              itemCount: rider.orderHistory.length,
              itemBuilder: (ctx, i) {
                final o = rider.orderHistory[i];
                final color = COLORS[o["status"]] ?? tc.textLight;
                  ...
                  child: Container(
                    ...
                    child: Row(children: [
                      ...
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Text("Total: \$${((o["total"] as num?)??0).toStringAsFixed(0)}", style: TextStyle(color: tc.textLight, fontSize: 13)),
                        () {
                          ...
                          return Text("$time · $date", style: TextStyle(color: tc.textLight, fontSize: 11));
                        }(),
                      ])),
